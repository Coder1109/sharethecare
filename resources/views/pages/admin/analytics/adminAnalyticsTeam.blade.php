    ...
    <div class="content-header row">
        <div class="content-header-left col-md-9 col-12 mb-2">
            <div class="row breadcrumbs-top">
                <div class="col-md-12">
                    <h2 class="col-md-12 content-header-title float-left mb-0 text-uppercase">Team Analytics</h2>
                    <div class="breadcrumb-wrapper col-md-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item">Analytics
                            </li>
                            <li class="breadcrumb-item">Team Analytics
                            </li>
                        </ol>
                    </div>
                </div>
                        ...
                        <div class="card-header">
                            <div class="row">
                                <div class="col-12">
                                    ...
                                    <h4 class="card-title">Referrer Analytics</h4>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <div class="row">
                                <div class="col-12">
                                    <h4 class="card-title">Team Member Analytics</h4>
                                </div>
                            </div>
                        </div>
                        <div class="card-content">
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <div class="row">
                                <div class="col-12">
                                    <h4 class="card-title">Review Request Analytics</h4>
                                </div>
                            </div>
                        </div>
                        <div class="card-content">
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <div class="row">
                                <div class="col-12">
                                    <h4 class="card-title">Office Analytics</h4>
                                </div>
                                {{--                                    <div class="col-7">--}}
                                    ...
                                    <table class="table">
                                        ...
                                        @foreach($users as $user)
                                            <tr>
                                                ...
                                                <td>
{{--                                                    <a href="{{ route('adminUsers.show', ['user' => $user->id]) }}">--}}
                                                        {{ $user->name }}
{{--                                                    </a>--}}
                                                </td>
                                                <td>
