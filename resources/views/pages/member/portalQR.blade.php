                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="form-group">
                                                <label for="name" class="col-md-12 col-form-label">Please select Patient <a class="text-danger font-14">*</a></label>
                                                    ...
                                                    <div class="col-md-6 pr-md-0">
                                                        ...
                                                        <div class="position-relative has-icon-left pr-lg-1 pr-md-0">
                                                            <input type="date" class="form-control @error('dob') is-invalid @enderror"
                                                                   id="dob" name="dob" value="mm/dd/yyyy" required autocomplete="dob"/>
                                                            @error('dob')
                                                            <span class="invalid-feedback" role="alert">
                                                                <strong>{{ $message }}</strong>
                                                            </span>
                ...
                <div class="card">
                    ...
                    <div class="card-content">
                        ...
                        <div class="row justify-content-center align-items-center">
                            <button type="submit" class="col-lg-6 col-md-12 btn btn-relief-info waves-effect waves-light mb-1" onclick="printQR()">
                                <i class="mdi mdi-cellphone-message"></i>  &nbsp;&nbsp;&nbsp; SMS to Patient
                            </button>
                        </div>
                        <div class="row justify-content-center align-items-center">
                            <button type="submit" class="col-lg-6 col-md-12 btn btn-relief-dark waves-effect waves-light mb-3" onclick="printQR()">
                                <i class="ti-email"></i> &nbsp;&nbsp;&nbsp; Email Patient
                            </button>
                        </div>
                    </div>
                    </div>
