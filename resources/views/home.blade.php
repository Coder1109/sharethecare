                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-12">
                                                            <div class="form-group">
                                                                <label for="name" class="col-md-12 col-form-label">Name
                                                                    <a class="text-danger font-14">*</a></label>
                                                        ...
                                                        <div class="col-12">
                                                            <div class="form-group">
                                                                <label for="phone" class="col-md-12 col-form-label">Phone
                                                                    <a class="text-danger font-14">*</a></label>
                                                                <div class="position-relative has-icon-left">
                                                                    <input id="phone"
                                                        ...
                                                        <div class="col-12">
                                                            <div class="form-group">
                                                                <label for="assisted_by"
                                                                       class="col-md-12 col-form-label">Assisted By
                                                                    Employee</label>
                                                                <div class="position-relative has-icon-left">
                                                                    <select id="assisted_by"
                                                                            ...
                                                                            name="assisted_by"
                                                                            {{--                                                           value="{{$user->name}}" --}}
                                                                            required autocomplete="assisted_by"
                                                                            autofocus>
                                                            ...
                                                            <div class="row justify-content-center">
                                                                ...
                                                                <div class="col-lg-3 col-md-12">
                                                                    <button id="generateQR" type="button"
                                                                        ...
                                                                        <i class="fa fa-qrcode m-r-5"></i> Generate QR
                                                                        Code
                                                                    </button>
                                                                </div>
                                                            </div>
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-content">
                                            <div class="card-body py-3">
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-8 col-md-12 d-flex justify-content-center">
                                                        <img class="img-fluid qr-image"
                                                             id="qr_image"
                                                             src="{{asset('images/default_image.png')}}" width="300"
                                                             height="300"/>
                                                    </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-12">
                                                                <button type="button" id="sendSms"
                                                                        class="col-10 btn btn-relief-primary waves-effect waves-light px-1 mt-2">
                                                                    SMS
                                                                </button>
                                                            </div>
                                                            <div class="col-12">
                                                                <button type="button" id="sendMms"
                                                                        class="col-10 btn btn-relief-danger waves-effect waves-light px-1 mt-2">
                                                                    MMS
                                                                </button>
                                                            </div>
                                                            <div class="col-12">
                                                                <button type="button" id="sendQR"
                                                                        class="col-10 btn btn-relief-success waves-effect waves-light px-1 mt-2">
                                                                    Email
                                                                </button>
                                                            </div>
                                                            <div class="col-12">
                                                                <button type="button" id="sendReview"
                                                                        class="col-10 btn btn-relief-info waves-effect waves-light px-1 mt-2">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-8">
                                                        <label for="phone_number" class="col-md-8 col-form-label">Send
                                                            To
                                                            <a class="text-danger font-14">*</a></label>
                                                        <div class="position-relative has-icon-left">
