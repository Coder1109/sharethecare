                        ...
                        <div class="card rounded-0 mb-0 p-2">
                            ...
                            <div class="card-content">
                                <div class="card-body pt-0">
                                    <form method="POST" action="{{ route('referegister') }}">
                                        @csrf

                                        <div class="form-group row">
                                            <label for="name"
                                                   class="col-md-4 d-flex align-items-center text-md-right">Business|Clinic Name</label>

                                            <div class="col-md-8">
                                                <input id="name" type="text"
                                                       class="form-control @error('clinic') is-invalid @enderror"
                                                       name="clinic" value="{{ old('clinic') }}" required
